...
import perforated from "@/assets/perforated-tray.jpg";
...
const Products = () => {
  ...
  // Default mode for each product is "specifications"
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Form submitted:", { product: selectedProduct.title, ...formData });
  ...
  const products = [
    ...
    },
    {
      ...
      specifications: [
        "Guards against rust & chemicals",
        "Open design for cable access",
        "High load capacity",
        "Industrial & utility ready",
        "Full accessory range"
      ],
      details: "Built for high load, tough industrial and utility projects."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            High-quality cable trays and raceways designed for reliable cable
            management and fast installation
          </p>
        </div>
                ...
                <CardContent className="flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      className="flex-1 border-[#045AA2] text-[#045AA2] hover:bg-[#045AA2] hover:text-white"
                    ...
                    <Button
                      asChild
                      size="sm"
                      className="flex items-center bg-[#EF7F1A] hover:bg-[#045AA2] text-white"
                    >
  ...
  {/* Send Inquiry button */}
  <Button type="submit" className="flex-1 bg-[#FB923C] hover:bg-[#f97316]">
    Send Inquiry
  </Button>

  {/* WhatsApp button */}
  <a
    href={`https://wa.me/91XXXXXXXXXX?text=Hello, I am interested in ${encodeURIComponent(selectedProduct.title)}`}
    target="_blank"
